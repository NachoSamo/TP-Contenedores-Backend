...
-- ESTADOS
-- Aseguramos que el id=1 sea CONTENEDOR:DISPONIBLE (usado por contenedores)
-- Estados de solicitudes:  [borrador - programada - en tránsito - entregada]
-- Estados de tramos:      [estimado, asignado, iniciado, finalizado]
...
-- CONTENEDORES
-- Nota: asume que existe un estado con id_estado = 1 (p.ej. 'CONTENEDOR: DISPONIBLE')
...
-- DEPOSITOS
-- Asume geolocalizaciones con IDs 1 y 2 ya creadas
...
-- Asume id_estado = 1 (CONTENEDOR: DISPONIBLE) y clientes ya existentes
INSERT INTO contenedores (id_estado, id_cliente, peso_kg, volumen_m3, costo_base_km) VALUES
...
-- CAMIONES (4 nuevos)
-- Asume transportistas con IDs 1..4 y geolocalizaciones con IDs 1..2
...
-- SOLICITUDES (3 nuevas)
-- Usa subconsultas para no depender de IDs autogenerados
...
-- RUTAS (3 nuevas) vinculadas a las solicitudes creadas
...
-- TRAMOS (4 nuevos)
-- Usa subconsultas para resolver FKs sin depender de IDs autogenerados

-- 1) Ruta de cliente 20123456 - tramo 1: CABA -> Depósito CABA Centro
INSERT INTO tramos (
...
-- 2) Ruta de cliente 20123456 - tramo 2: Depósito CABA Centro -> Córdoba (geoloc)
INSERT INTO tramos (
...
-- 3) Ruta de cliente 23987654 - tramo único: CABA -> Córdoba
INSERT INTO tramos (
...
-- 4) Ruta de cliente 27876543 - tramo 1: Depósito Córdoba Centro -> Depósito Córdoba Sur (operación de depósito)
INSERT INTO tramos (
...
-- TARIFAS (3 nuevas)
-- Asume camiones existentes: AA123BB, AC456CD, AG012GH, AE789EF
INSERT INTO tarifas (dominio_camion, tipo_tarifa, costo_litro_combustible, cargo_gestion_tramo) VALUES
  ('AA123BB', 'BASE',      950.0,  2500.0),
  ('AC456CD', 'NOCTURNO', 1000.0,  3200.0),
  ('AG012GH', 'URBANO',    980.0,  2800.0);
